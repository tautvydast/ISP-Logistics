 ...
 */
public class TransportCreateDialog extends JDialog {
    ...
    public TransportCreateDialog(String title) {
    ...
    private void saveTransport() {
        ...
        transport Car = new transport(markeField.getText(),modelisField.getText(),talpaField.getText(),
        ...
        TransportUtil.addTransport(Car);
        setVisible(false);
        dispose();
    }
